...
function drawScoreboard(scoreArry) {
    ...
    for (var i = 0; i < scoreArry.length; i++) {
    	...
    	scoreList.append('<li class="playerScores"><input type="button" id="win" value="+" class="button-score" onClick="addWin(`' + player +'`, 1, gameScoreboard)"><input type="button" id="tradeIn" class="button-score" value="&minus;" onClick="removeWin(`' + player +'`, 1, gameScoreboard)">'+ player +' : '+ score+'</li>');
    }
}
